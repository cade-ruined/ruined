...
const PAGES: SearchDocument[] = [
  {
    ...
    description: "Move through the Lobby, Store, About, Members, and Community.",
    meta: "Experience",
    href: "/#top",
    searchable: "home journey explore walk lobby store about members community events rooms experience",
    priority: 100,
  },
  {
    id: "shop",
  ...
  },
  {
    ...
    group: "pages",
    title: "Artifacts",
    description: "Artifacts from The Ruined Project are coming soon.",
    meta: "Coming soon",
    href: "/work",
