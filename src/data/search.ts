...
const PAGES: SearchDocument[] = [
  {
    ...
    description: "Move through the Lobby, Store, Work, About, and Events.",
    meta: "Experience",
    href: "/#top",
  ...
  },
  {
    ...
    href: "/work",
    searchable: "work projects archive portfolio objects spaces garments systems design",
    priority: 90,
  },
  {
    id: "about",
  ...
  },
  {
    ...
    meta: "Programme",
    href: "/events",
    searchable: "events programme calendar open studio conversations installations sessions fireside",
    priority: 80,
  },
  {
    id: "contact",
  ...
  },
  {
    ...
    description: "Delivery, returns, exchanges, duties, and order support.",
    meta: "Service",
    href: "/shipping-returns",
    searchable: "shipping delivery returns exchanges duties order support service",
    priority: 40,
  },
  {
    id: "privacy",
  ...
  },
  {
    ...
    group: "pages",
    title: "Terms",
    description: "Terms governing use of the site and store.",
    meta: "Policy",
    href: "/terms",
    searchable: "terms conditions policy site store",
    priority: 20,
  },
];
