  ...
  return (
    <div className="max-w-[46rem]">
      {paragraphs.map((paragraph, index) => (
        <p
          className={`${index === 0 ? "font-[var(--font-display)] text-[clamp(1.85rem,4vw,3.25rem)] leading-[0.96] tracking-[-0.035em]" : "mt-7 font-[var(--font-body)] text-[0.98rem] leading-7 text-[var(--member-muted)] sm:text-base sm:leading-8"} whitespace-pre-wrap`}
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-xl">
        <span className="mb-5 inline-flex h-12 w-12 items-center justify-center rounded-full border border-[var(--member-rule)] bg-[var(--member-soft)]">
          <PlayMark />
        </span>
        <p className="font-[var(--font-body)] text-[0.64rem] font-semibold uppercase tracking-[0.12em] text-[var(--member-muted)]">
          Hosted lesson
        </p>
  ...
  return (
    <aside aria-labelledby="academy-up-next" className={`${styles.relatedRail} min-w-0 lg:max-h-[min(39vw,34rem)] lg:overflow-y-auto lg:pr-2`}>
      <div className="mb-4 flex items-end justify-between gap-3">
        <div>
          <p className="[font-family:var(--font-cadehandy2)] text-[1.25rem] leading-none text-[var(--member-red)]">
            Keep going
          </p>
        ...
        <span className="font-[var(--font-body)] text-[0.62rem] uppercase tracking-[0.1em] text-[var(--member-muted)]">
      ...
      <ol className="grid gap-3 sm:grid-cols-2 lg:grid-cols-1">
        {resources.map((item, index) => (
          <li key={item.id}>
            <Link
              className="group grid min-h-[6.2rem] grid-cols-[7rem_minmax(0,1fr)] gap-3 rounded-[0.35rem] bg-[var(--member-soft)] p-2 transition-colors hover:bg-[var(--member-soft)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
              href={item.href}
            >
              <span
              ...
              >
                <span className="absolute left-2 top-2 font-[var(--font-body)] text-[0.52rem] tracking-[0.1em] text-[var(--member-muted)]">
                ...
                {item.durationLabel ? (
                  <span className="absolute bottom-1.5 right-1.5 rounded-[0.15rem] bg-[var(--member-soft)] px-1.5 py-0.5 font-[var(--font-body)] text-[0.52rem] font-semibold tracking-[0.04em] text-white">
                    {item.durationLabel}
                  </span>
                ) : null}
              </span>
              <span className="min-w-0 py-1">
                <span className="block font-[var(--font-body)] text-[0.58rem] font-semibold uppercase tracking-[0.09em] text-[var(--member-red)]">
...
export default function MemberLearningArticle({
  ...
  return (
    <main className="member-journey-page member-lesson-page member-profile-dossier mx-auto max-w-[88rem] pb-20 pt-1 sm:pb-24" data-member-academy-lesson>
      <Link
        className="inline-flex min-h-11 items-center gap-2 font-[var(--font-body)] text-[0.65rem] font-semibold uppercase tracking-[0.1em] text-[var(--member-muted)] transition-colors hover:text-black focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
        href="/my/learn"
      >
      ...
      {isVideo ? (
        <>
          ...
          >
            <div className="min-w-0">
              ...
              <header className="mt-7 max-w-[58rem] sm:mt-9">
                <div className="flex flex-wrap items-center gap-x-3 gap-y-1 font-[var(--font-body)] text-[0.62rem] font-semibold uppercase tracking-[0.11em] text-[var(--member-muted)]">
                  <span className="text-[var(--member-red)]">{resource.collectionName ?? "Academy"}</span>
                ...
                {resource.summary ? (
                  <p className="mt-5 max-w-2xl font-[var(--font-body)] text-[0.96rem] leading-7 text-[var(--member-muted)] sm:text-base">
                    {resource.summary}
                  </p>
                ) : null}
                <p className="mt-5 font-[var(--font-body)] text-[0.6rem] uppercase tracking-[0.1em] text-[var(--member-muted)]">
          ...
          {hasBody ? (
            <section
              ...
              className="mt-14 grid gap-6 rounded-[0.45rem] bg-[var(--member-soft)] px-5 py-7 sm:mt-20 sm:px-8 sm:py-10 lg:grid-cols-[12rem_minmax(0,1fr)] lg:gap-12"
            >
              <div>
                <p className="[font-family:var(--font-cadehandy2)] text-[1.35rem] leading-none text-[var(--member-red)]">Mark it up</p>
        ...
        <article className="mt-7 max-w-[72rem]">
          <header className="max-w-[58rem]">
            <p className="[font-family:var(--font-cadehandy2)] text-[1.45rem] leading-none text-[var(--member-red)] sm:text-[1.7rem]">
              {resource.collectionName ?? "Ruined Academy"}
            </p>
            <p className="mt-4 font-[var(--font-body)] text-[0.62rem] font-semibold uppercase tracking-[0.11em] text-[var(--member-muted)]">
            ...
            {resource.summary ? (
              <p className="mt-7 max-w-2xl font-[var(--font-body)] text-base leading-7 text-[var(--member-muted)] sm:text-lg sm:leading-8">
                {resource.summary}
              </p>
            ) : null}
          ...
          {hasBody ? (
            <section aria-label="Resource text" className="mt-14 rounded-[0.45rem] bg-[var(--member-soft)] px-5 py-8 sm:mt-20 sm:px-9 sm:py-12">
              <ResourceCopy body={resource.bodyMarkdown} />
            </section>
          ) : !resource.externalUrl && !resource.storagePath ? (
            <p className="mt-14 max-w-2xl font-[var(--font-body)] text-sm leading-7 text-[var(--member-muted)]">
