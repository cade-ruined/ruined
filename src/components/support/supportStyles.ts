export const SUPPORT_FIELD_CLASS =
  "member-field mt-2 min-h-12 w-full rounded-[4px] border border-black/45 bg-white/25 px-3 py-3 [font-family:var(--font-body)] text-base text-[var(--color-faded)] outline-none placeholder:text-black/45 focus-visible:border-black focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-bone)] disabled:cursor-not-allowed disabled:opacity-50";

export const SUPPORT_LABEL_CLASS =
  "member-label block [font-family:var(--font-cadehandy2)] text-2xl leading-none text-[var(--color-poster)]";

export const SUPPORT_ACTION_CLASS =
