...
export default function PlatformUnavailable({
  ...
  return (
    <section className="grid min-h-[55vh] content-center border-t border-black/20 py-16">
      ...
      <p className="mt-8 max-w-xl text-sm leading-relaxed text-black/58 sm:text-base">
        {copy.description}
      </p>
      {accessHref && reason === "connection" ? (
        <Link
          className="mt-8 w-fit border-b border-black/35 pb-1 text-xs font-semibold uppercase tracking-[0.16em] text-black"
          href={accessHref}
        >
