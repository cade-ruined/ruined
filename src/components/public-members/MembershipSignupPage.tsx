...
export default function MembershipSignupPage({ initialPlan, enabled, preview }: {
  ...
  return <main className={`${styles.page} ${styles.signupPage}`}>
    <div className={styles.signupPageContent}>
      ...
      <MembershipSignup enabled={enabled} preview={preview} plan={plan} onPlanChange={changePlan} />
