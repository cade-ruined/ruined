...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return { title: `${card.name} / Member card`, description: "A member of Ruined. An introduction shared by its owner.", robots: { index: false, follow: false }, alternates: { canonical: url }, referrer: "no-referrer", openGraph: { type: "profile", title: `${card.name} / Ruined`, description: "A little introduction.", url, images: [{ url: image, width: 1200, height: 630, alt: `${card.name}'s Ruined member card` }] }, twitter: { card: "summary_large_image", title: `${card.name} / Ruined`, description: "A little introduction.", images: [image] } };
}
