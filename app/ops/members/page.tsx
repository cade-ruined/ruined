...
export default async function OperationsMembersPage() {
  ...
  return context.dashboard ? <OpsSection configuration={context.configuration} dashboard={context.dashboard} section="members" /> : <PlatformUnavailable accessHref="/ops/access" />;
}
